...
Contributions to MageCloudKit are very welcome! We follow a fairly standard [pull request process](https://help.github.com/articles/about-pull-requests/) for contributions, subject to the following guidelines:
...
functionality you're adding in your contribution. Check out the [tests](https://github.com/magecloudkit/magecloudkit/tree/master/test) folder for instructions on running the
automated tests. Our tests are written using the [Terratest](http://github.com/gruntwork-io/terratest) open-source testing library.
